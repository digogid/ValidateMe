...
namespace ValidateMe
{
    public static class Int32
    {
        ...
        /// <param name="propertyName">Name of the property. Default will get CallerMemberName</param>
        /// <returns>Returns true if the validation passes</returns>
        public static bool MustBeEqual(this int @this, int X, bool notify = true, [CallerMemberName]string propertyName = "")
        {
        ...
        /// <param name="propertyName">Name of the property. Default will get CallerMemberName</param>
        /// <returns>Returns true if the validation passes</returns>
        public static bool MustBeGreaterThan(this int @this, int X, bool notify = true, [CallerMemberName]string propertyName = "")
        {
        ...
        /// <param name="propertyName">Name of the property. Default will get CallerMemberName</param>
        /// <returns>Returns true if the validation passes</returns>
        public static bool MustBeSmallerThan(this int @this, int X, bool notify = true, [CallerMemberName]string propertyName = "")
        {
